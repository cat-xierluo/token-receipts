...
- **2026-05-09**
  ...
  - 调整 ASCII logo 颗粒度和页面缩放：保留高还原度字符稿，同时把 HTML 展示区域压缩到接近 Claude 默认 logo 的尺寸
  - 细化 OpenAI/Kimi/Z.ai ASCII：OpenAI 强化交叠环形层次，Kimi 按 K-only 官方图形重画，Z.ai/GLM 改为规整阶梯式 Z
